    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cinema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cinema_show', to='reservations.cinema')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movie_show', to='reservations.movie')),
            ],
        ),
        migrations.CreateModel(
            name='Bookings',
            fields=[
                ...
                ('shows', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservations.shows')),
            ],
        ),
    ]
